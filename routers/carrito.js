...
router.put('/modificarPorId/', modificarCarrito) //eliminar de la lista
...
async function mostrarCarrito(req, res) { //todo, pero se muestra por producto
    try {
        ...
        // Envía la respuesta con los datos del carrito
